(function($) {
    $.fn.simpleJekyllSearch = function(options) {
        var settings = $.extend({
            ...
            template : '<li><article><a href="{url}">{title} <span class="entry-date"><time datetime="{dateISO}">{date}</time></span></a></article></li>',
            searchResults   : '.search-results',
            searchResultsTitle   : '<h4>Resultados:</h4>',
            limit           : '5',
            noResults       : '<p>Ihhhh!<br/><small>Não achei nada com esse termo! :(</small></p>'
        }, options);
